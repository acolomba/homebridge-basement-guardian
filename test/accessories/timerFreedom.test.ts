...
// The accessories tier holds six modules. A gate that enumerated fewer than this
// read the wrong directory, and every assertion built on that read would pass
