...
// force-includes `package.json`, `LICENSE`, `COPYING`, and `README.md` whatever the allowlist
// says (D-21).
const ALLOWED_ROOT_FILES = ['CHANGELOG.md', 'COPYING', 'LICENSE', 'NOTICE', 'README.md', 'config.schema.json', 'package.json'];
