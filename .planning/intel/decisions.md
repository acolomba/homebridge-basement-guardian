...
- decision: |
    ...
    The heartbeat evidence is preserved in the [ingested operational context](context.md), and the field inventory is preserved in the [ingested protocol constraints](constraints.md).
    DATA_973ee061_END
