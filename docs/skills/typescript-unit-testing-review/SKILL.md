...
This skill is the review-time counterpart of the `typescript-unit-testing-rule.md` Claude Code rule; the two state the same rules and must not disagree. When revising, produce the rule file's **Good** form.
